...
Invaders.MechanicOne.prototype = {
  ...
  enemyFires: function() {
    ...
    var firingTimerRandom = [200, 600, 800, 1000, 1200, 1400];
    var item =
  ...
  playerHitsUfo: function(enemy, bullet) {
    ...
    if (enemy.alive == false) {
      ...
      this.scoreText.text = this.scoreString + this.scoreNumber;
      const pointsAdded = this.add.text(
        enemy.body.x + 15,
        enemy.body.y + 15,
        " +300",
        {
      ...
      let tweenA = this.add.tween(pointsAdded);
      tweenA.to(
        {
          y: enemy.body.y - 10,
          alpha: 0
  ...
  bulletToBulletCollision: function(bulletOne, bulletTwo) {
    ...
    let haloAnimPrivate = this.haloTwo.getFirstExists(false);
