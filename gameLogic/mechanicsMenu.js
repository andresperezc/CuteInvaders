...
Invaders.MechanicsMenu.prototype = {
  create: function() {
    ...
    this.button10 = this.make.button(
      289,
      522,
      "buttonTen",
      this.mechanicTen,
    ...
    this.button11 = this.make.button(
      444,
      522,
      "buttonEleven",
      this.mechanicEleven,
    ...
    this.button12 = this.make.button(
      599,
      522,
      "buttonTwelve",
      this.mechanicTwelve,
    ...
    this.button13 = this.make.button(
      755,
      522,
      "buttonThirteen",
      this.mechanicThirteen,
      this,
      1,
      0,
      2
